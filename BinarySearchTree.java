...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    /* private version of the public getNumberOfLeaves method*/
    ...
    public ArrayList<E> leftSubTree(E e) {
        ...
        current = current.left;
        preorderForSubTree(current, list);
        return list;

    }

    protected void preorderForSubTree(TreeNode<E> root, ArrayList<E> list) {
        if (root == null) {
            return;
        }
        list.add(root.element);
        preorderForSubTree(root.left, list);
        preorderForSubTree(root.right, list);
    }
    ...
    /* public version of the private sameTree method*/
    public boolean sameTree(BinarySearchTree tree) {
        return sameTree(this.root, tree.root);
    }

    /* returns a boolean after comparing the data inside each node */
